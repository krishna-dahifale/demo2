...
<table color="white" align="left">
<br><br><br><br><tr><td><h3>FeedbackId</h3></td><td ><input type="text" name="feedback_id" class="td1"></td></tr>
<tr><td><h3>TraineeId</h3></td><td width="20%"><input type="text" name="trainee_id" class="td1"></td></tr></table>
...
{%>
<table>
<tr><td colspan="5"><b><h3><%=ss.getQuestion()%></h3></b></td></tr>
<tr>
<td><input type="radio" name="<%=ss.getQuestion_id()%>" value="5">Strongly Agree</td>
<td><input type="radio" name="<%=ss.getQuestion_id()%>" value="4">Agree</td>
<td><input type="radio" name="<%=ss.getQuestion_id()%>" value="3">Neutral</td>
<td><input type="radio" name="<%=ss.getQuestion_id()%>" value="2">Disagree</td>
<td><input type="radio" name="<%=ss.getQuestion_id()%>" value="1"> Strongly Disagree</td>
</tr>

<%} %>
<br><br><tr><td><input type="submit" value="Submit" name ="Submit" class="submitbtn"/></td>
	<td><input type="reset" value="Reset" name="Reset" class="cbtn"></td>
</tr>
