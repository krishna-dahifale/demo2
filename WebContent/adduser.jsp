    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
             <h2 id="homeHeading">Add User</h2>
             
<form action="AddSystemUserController" method="post" name="myForm" onsubmit="returnvalidateForm()">
<table align="center" >
...
<tr>
  ...
  Role ID:
    ...
    <td><input type="text" name="roleid" placeholder="Enter Role Id" required/>
  </td>
  </tr>
 ...
 Last Name:
    ...
    <td><input type="text" name="lname" placeholder="Last name" required/>
  </td>
  </tr>
  ...
  <td>
  E-mail Id: </td>
   <td><input type="email" name="emailid"  placeholder="email" required/>
  </td>
  </tr>
  ...
  <td>
  Contact No.: </td>
   <td><input type="text" name="contact_no" placeholder="9999999999" maxlenght="10" pattern="[1-9]{1}[0-9]{9}" required/>
  </td>
  </tr>
