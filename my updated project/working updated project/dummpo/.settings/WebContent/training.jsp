...
<FORM ACTION="TrainingController" METHOD="GET">

<table border="1" align="center">
  <br><br><h2>Training Details</h2><br><br><tr><th>Training ID</font></th>
	<th>Training Name </font></th>
	...
	<th>Update Training</font></th>
	<th>Delete Training</font></th></tr>
	<%
...
List<Training> tlist=ts.viewTrainee();
int cn=0;
String s="Training";


		
		for(Training detail:tlist)
		{ %>
<tr>
<td><b><a href="training_view.jsp?training_id=<%=detail.getTraining_id()%>"><%=detail.getTraining_id()%></a></font></b></td>
<td><b><%=detail.getTraining_name()%></font></b></td>


<td><b><a href="updatetraining.jsp?training_id=<%=detail.getTraining_id()%>">update</a> </font></b></td>
...
<td><b><a href="TrainingDeleteController?training_id=<%=detail.getTraining_id()%>&status=INACTIVE">DELETE</a></font></b></td>

<%}else{ %>

<td><b><a href="TrainingDeleteController?training_id=<%=detail.getTraining_id()%>&status=ACTIVE">ACTIVATE</a></font></b></td>
