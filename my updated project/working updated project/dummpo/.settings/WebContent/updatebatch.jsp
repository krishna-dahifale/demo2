    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
              <h2 id="homeHeading">Update Batch</h2>
              
                <form action="BatchUpdateController">
				<table align="center" >
				<%	
int m=Integer.parseInt(request.getParameter("batch_id"));
 ...
 Batch ID:
    ...
    <td><input type="text" name="batch_id" id="textname" size="30" value="<%=t.getBatch_id()%>" required/>
  </td>
  </tr>
 ...
 Training ID:
    ...
    <td><input type="text" name="training_id" id="textname" size="30" value="<%=t.getTraining_id()%>"  required/>
  </td>
  </tr>
  ...
  Batch Name:
    ...
    <td><input type="text" name="batch_name" id="textname" size="30" value="<%=t.getBatch_name()%>" required/>
  </td>
  </tr>
  ...
  No. Of Trainee:
    ...
    <td><input type="text" name="no_of_trainee" id="textname" size="30" value="<%=t.getNo_of_trainee()%>" required/>
  </td>
  </tr>
...
<td> <div class="contain" >
  <button type="submit" class="cbtn" style="float: center">Update</button>
 ...
 <td > <div class="contain" >
  <button type="reset" class="cbtn" style="float: center;">clear</button>
