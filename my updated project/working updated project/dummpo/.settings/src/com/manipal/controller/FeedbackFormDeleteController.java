...
/**
 * Servlet implementation class FeedbackFormDeleteController
 */
@WebServlet("/FeedbackFormDeleteController")
public class FeedbackFormDeleteController extends HttpServlet {
    ...
    public FeedbackFormDeleteController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			result=ffs.deleteFeedbackForm(id, status);
