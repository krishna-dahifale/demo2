...
public class TraineeServiceImpl implements TraineeService{
	...
	@Override
	public int AddTrainee(int trainee_id,int username, String password, String first_name,
			String last_name, String email_id, String dob, long contact_no,
			String h_qualification, String d_o_joining,
			String status) throws Exception {
		// TODO Auto-generated method stub
		
		Trainee trainee=new Trainee(trainee_id,username,password,first_name,last_name,email_id,dob,contact_no,h_qualification,d_o_joining,status);
