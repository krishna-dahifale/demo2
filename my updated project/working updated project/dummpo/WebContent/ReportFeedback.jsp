...
<head>
    ...
    <link href="D:\Java_Workspace\J2EE\TrainingFeedbackSystem\css\login.css" rel="stylesheet">
...
<table border="1" align="center">
  <br><br><h2>Feedback Report</h2><br><br><tr><th>Feedback ID</font></th>
	<th>Trainee ID</font></th>
	...
	<th>Average Rating</font></th></tr>
<%
FeedbackFormReportService ts= new FeedbackFormReportServiceImpl();
List<Report> tlist=ts.viewFeedbackFormReport();
...
{%>
<tr>
<td><b><%=fr.getFeedback_id()%></font></b></td>
<td><b><%=fr.getTrainee_id()%></font></b></td>
<td><b><%=fr.getAvg_rating() %></font></b></td>
</tr>
