...
<body id="page-top">
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
              <h2 id="homeHeading">Add Batch</h2>
 ...
 Training ID:
   ...
   <!--  <td><input type="text" name="training_id" Placeholder="Enter Training ID" required/> -->
<tr><td>
  ...
  Batch Name:
   ...
   <tr>
    <td><input type="text" name="batch_name" Placeholder="Enter Batch name" required/>
  </td>
  </tr>
...
<td >
 ...
 <div class="contain" >
  <input type="submit" class="submitbtn" style="float: left;" name="Submit" value="Submit">
