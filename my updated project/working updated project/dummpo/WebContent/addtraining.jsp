    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
             <h2 id="homeHeading">Add Training</h2>
...
<table align="center" >
  ...
  Training Name: </td>
  <td width="60%">
  <input type="text" name="TRAINING_NAME" placeholder="Enter Training Name" required/></td>
  </tr>
  ...
  <td width="60%">
  <input type="number" name="TRAINING_DURATION" placeholder="Enter Training Duration" required/></td>
  </tr>
 ...
 <tr  >
  ...
  <td width="60%">
  <input type="text" name="TRAINING_DISCRIPTION" placeholder="Enter Training Description" required/></td>
  </tr>
...
<td >
 ...
 <div class="contain" >
  <input type="submit" class="submitbtn" style="float: left;" value="Submit">
