    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
             <h2 id="homeHeading">Update Training</h2>
...
<tr>
  ...
  Training ID:
    ...
    <td><input type="text" name="training_id" id="textname" size="30" value="<%=t.getTraining_id()%>" placeholder="Enter Name" required/>
  </td>
  </tr>
  ...
  Training Name: </td>
  <td >
  <input type="text" name="training_name" id="textname" size="30" value="<%=t.getTraining_name()%>" placeholder="Enter ID" required/></td>
  </tr>
  ...
  <td >
  <input type="text" name="training_duration" id="textname" size="30" value="<%=t.getTraining_duration()%>" placeholder="Enter ID" required/></td>
  </tr>
  ...
  <td >
  <input type="text" name="training_duration" id="textname" size="30" value="<%=t.getDiscription()%>" placeholder="Enter ID" required/></td>
  </tr>
