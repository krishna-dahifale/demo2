...
<body id="page-top">
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <br><br><br><br><br><h2 id="homeHeading">Add Course</h2>
  ...
  Course Id:
    ...
    <td><input type="text" name="cid" value="Enter Course Id" required/>
  </td>
  </tr>
  <tr>
  <td>
  Course Name </td>
   <td><input type="text" name="cname" value="Enter Course Name" required/>
  </td>
  </tr>
  <tr>
  <td>
  Course Duration: </td>
   <td><input type="text" name="cduration" value="Enter Duration of course" required/>
  </td>
  </tr>
